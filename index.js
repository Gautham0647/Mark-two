...
var userName = readlineSync.question(
	chalk.blue.bold("What's your good name?: ")
);

console.log(
	chalk.bold.yellow(
		'\n Welcome to The Avengers Quiz!, ' +
			chalk.magenta(userName.toUpperCase()) +
			'. \n'
	)
);
...
var avengers_question_bank = [
	...
	{
		question:
			'At the end of Doctor Strange, the titular character uses the Time Stone to trap a villain in a time loop. Who is the villain?\n',
		answer: 'A',
		option1: 'Dormammu',
		option2: 'Red Skull',
		option3: 'Mad Titan',
	...
	{
		question:
			'Before Thanos, which other character tries to get his hands on all the Infinity Stones?\n',
		answer: 'A',
	...
	{
		question:
			'In Iron Man 2, Tony Stark saves a child wearing an Iron Man mask from a drone. Who is this child?\n',
		answer: 'C',
